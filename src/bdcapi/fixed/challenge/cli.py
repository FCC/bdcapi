...
from bdcapi.fixed.challenge.api import EntityChallengeAPITask
...
#
# Arguments for Bulk Fixed Challenge Withdraw API
#
...
def withdraw( task, challenge_file, **kwargs ):
    ...
    for challenge_id_list in task.chunk_api_calls(challenge_ids, chunk_size):
        rspjson     =   task.fcp_withdraw_challenge(challenge_id_list)
